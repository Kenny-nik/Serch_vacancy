...
from src.utils import filter_vacancies, get_top
...
def test_filter_vacancies(list_vacancies):
    ...
    filtered_vacancies = filter_vacancies(list_vacancies, keywords)
...
def test_no_keywords(list_vacancies):
    ...
    result = filter_vacancies(list_vacancies, empty_keywords)
